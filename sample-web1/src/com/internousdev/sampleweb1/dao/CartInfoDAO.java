...
public class CartInfoDAO {
	...
	public List<CartInfoDTO> getCartInfoDtoList(String userId){
		...
		try{
			...
			System.out.println("cartinfodao-getcartinfodtolist:" + userId);
			...
			while(resultSet.next()){
				...
				cartInfoDTO.setTempUserId(resultSet.getString("itemp_user_id"));
...
public int regist(String userId, String tempUserId, int productId, String productCount, int price){
	...
	public int linkToLoginId(String tempUserId, String userId){
		DBConnector dbConnector = new DBConnector();
		Connection connection = dbConnector.getConnection();
		int count = 0;
